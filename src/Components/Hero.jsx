...
const Hero = ({ HeroImage }) => {
    return (
        <article className="w-full flex justify-center py-15 rounded-2xl">
            <div className="w-[60%] h-110 bg-[#e4f1ff] rounded-2xl flex items-center justify-between relative">
                <section className="w-[55%] h-full"><img className="w-full h-full rounded-l-2xl" src={HeroImage} alt="" /></section>
                ...
                <div className="border-2 border-white p-3 rounded-[50%] bg-white text-orange-500 hover:bg-orange-500 hover:text-white absolute bottom-3 right-3">
